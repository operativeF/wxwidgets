...
void wx_jpeg_io_dest(j_compress_ptr cinfo, wxOutputStream& outfile)
{
    wx_dest_ptr dest;
...
void wx_cmyk_to_rgb(unsigned char* rgb, const unsigned char* cmyk)
{
    int k = 255 - cmyk[3];
    int k2 = cmyk[3];
...
/*static*/ wxVersionInfo wxJPEGHandler::GetLibraryVersionInfo()
{
    ...
    return {"libjpeg", {JPEG_LIB_VERSION_MAJOR, JPEG_LIB_VERSION_MINOR}};
#else
    return {"libjpeg", {JPEG_LIB_VERSION / 10, JPEG_LIB_VERSION % 10}};
#endif
}
