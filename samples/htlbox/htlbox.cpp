...
protected:
    ...
    void OnDrawSeparator(wxDC& dc, wxRect& rect, size_t n) const override;
    wxColour GetSelectedTextColour(const wxColour& colFg) const override;
...
{
public:
    bool OnInit() override { (new MyFrame())->Show(); return true; }
};
