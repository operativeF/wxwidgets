...
protected:
#if wxUSE_LOG
    wxAppTraits *CreateTraits() override { return new MyAppTraits; }
#endif // wxUSE_LOG
...
protected:
    ...
    void AddAdditionalTextOptions(wxSizer *sizer) override;
    void AddAdditionalFlags(wxSizer *sizer) override;
