...
export module WX.Test.TextCtrl;
...
std::unique_ptr<wxTextCtrl> CreateText(long extraStyles)
{
...
void DoPositionToCoordsTestWithStyle(unsigned int style)
{
...
void DoPositionToXYMultiLine(unsigned int style)
{
...
void DoXYToPositionMultiLine(unsigned int style)
{
    auto m_entry = CreateText(style | wxTE_MULTILINE | wxTE_DONTWRAP);
