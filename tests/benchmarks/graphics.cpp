...
public:
    virtual void OnInitCmdLine(wxCmdLineParser& parser)
    {
        ...
        {
            { wxCmdLineEntryType::Switch, "",  "bitmaps" },
            { wxCmdLineEntryType::Switch, "",  "images" },
            { wxCmdLineEntryType::Switch, "",  "lines" },
            { wxCmdLineEntryType::Switch, "",  "rawbmp" },
            { wxCmdLineEntryType::Switch, "",  "rectangles" },
            { wxCmdLineEntryType::Switch, "",  "circles" },
            { wxCmdLineEntryType::Switch, "",  "ellipses" },
            { wxCmdLineEntryType::Switch, "",  "textextent" },
            { wxCmdLineEntryType::Switch, "",  "multilinetextextent" },
            { wxCmdLineEntryType::Switch, "",  "partialtextextents" },
            { wxCmdLineEntryType::Switch, "",  "paint" },
            { wxCmdLineEntryType::Switch, "",  "client" },
            { wxCmdLineEntryType::Switch, "",  "memory" },
            { wxCmdLineEntryType::Switch, "",  "dc" },
            { wxCmdLineEntryType::Switch, "",  "gc" },
#if wxUSE_GLCANVAS
            { wxCmdLineEntryType::Switch, "",  "gl" },
#endif // wxUSE_GLCANVAS
            { wxCmdLineEntryType::Option, "m", "map-mode", "", wxCmdLineParamType::Number },
            { wxCmdLineEntryType::Option, "p", "pen-width", "", wxCmdLineParamType::Number },
            { wxCmdLineEntryType::Option, "s", "pen-style", "solid | dot | long_dash | short_dash", wxCmdLineParamType::String },
            { wxCmdLineEntryType::Option, "",  "pen-quality", "default | low | high", wxCmdLineParamType::String },
            { wxCmdLineEntryType::Option, "w", "width", "", wxCmdLineParamType::Number },
            { wxCmdLineEntryType::Option, "h", "height", "", wxCmdLineParamType::Number },
            { wxCmdLineEntryType::Option, "I", "images", "", wxCmdLineParamType::Number },
            { wxCmdLineEntryType::Option, "N", "number-of-iterations", "", wxCmdLineParamType::Number },
#ifdef __WXMSW__
            { wxCmdLineEntryType::Option, "r", "renderer", "gdiplus | direct2d | cairo", wxCmdLineParamType::String },
#endif // __WXMSW__
