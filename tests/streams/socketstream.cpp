...
private:
    ...
    wxSocketInputStream  *DoCreateInStream() override;
    wxSocketOutputStream *DoCreateOutStream() override;
    void DoCheckInputStream(wxSocketInputStream& stream_in) override;
