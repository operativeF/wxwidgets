...
TEST_CASE("ArgsValidation", "[wxString][vararg][error]")
{
    ...
    // but these are not:
    CHECK_THROWS( wxString::Format("%i", "foo") );
    CHECK_THROWS( wxString::Format("%s", (void*)&written) );
    CHECK_THROWS( wxString::Format("%d", ptr) );
    ...
    CHECK_THROWS( wxString::Format("foo%i%n", &written) );
    CHECK_THROWS( wxString::Format("foo%n", ptr) );
    CHECK_THROWS( wxString::Format("foo%i%n", 42, &swritten) );
