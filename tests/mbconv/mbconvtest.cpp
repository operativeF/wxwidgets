...
// encoded by iconv
static constexpr unsigned char welcome_utf7_iconv[84] =
{
...
static constexpr unsigned char welcome_utf7_wx[109] =
{
...
// encoded by iconv
static constexpr unsigned char welcome_utf8[89] =
{
    0x57,0x65,0x6c,0x63,0x6f,0x6d,0x65,0x20,0x74,0x6f,0x20,0x6f,0x75,0x72,0x20,0x63,
    0x79,0x62,0x65,0x72,0x20,0x73,0x70,0x61,0x63,0x65,0x20,0x66,0x6f,0x72,0x63,0x65,
...
// encoded by iconv
static constexpr unsigned char welcome_utf16le[106] =
{
...
// encoded by iconv
static constexpr unsigned char welcome_utf16be[106] =
{
...
// encoded by iconv
static constexpr unsigned char welcome_utf32le[212] =
{
...
// encoded by iconv
static constexpr unsigned char welcome_utf32be[212] =
{
...
// encoded by iconv
static constexpr unsigned char welcome_cp932[71] =
{
    0x57,0x65,0x6c,0x63,0x6f,0x6d,0x65,0x20,0x74,0x6f,0x20,0x6f,0x75,0x72,0x20,0x63,
    0x79,0x62,0x65,0x72,0x20,0x73,0x70,0x61,0x63,0x65,0x20,0x66,0x6f,0x72,0x63,0x65,
...
static constexpr unsigned char iso8859_1[251] =
{
...
static constexpr unsigned char iso8859_1_utf8[379] =
{
    0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x11,0x12,0x13,0x14,
    0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,
    0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,0x30,0x31,0x32,0x33,0x34,
...
static constexpr unsigned char CP1252[246] =
{
    0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x11,0x12,0x13,0x14,
    0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,
    0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,0x30,0x31,0x32,0x33,0x34,
...
// the above character sequence encoded as UTF-8 (iconv)
static constexpr unsigned char CP1252_utf8[386] =
{
    0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x11,0x12,0x13,0x14,
    0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,
    0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,0x30,0x31,0x32,0x33,0x34,
...
static constexpr unsigned char iso8859_5[251] =
{
    0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x11,0x12,0x13,0x14,
    0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,
    0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,0x30,0x31,0x32,0x33,0x34,
...
// the above character sequence encoded as UTF-8 (iconv)
static constexpr unsigned char iso8859_5_utf8[380] =
{
    0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x11,0x12,0x13,0x14,
    0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,
    0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,0x30,0x31,0x32,0x33,0x34,
...
void MBConvTestCase::Latin1Tests()
{
    ...
    static constexpr char nulstr[] = "foo\0bar\0";
    static constexpr size_t mbLen = WXSIZEOF(nulstr) - 1;
    size_t wcLen;
    ...
    )
{
    ...
    wxTextOutputStream textOutputStream( memoryOutputStream, wxEOL::Unix, converter );
    for ( size_t i = 0; i < wideChars; i++ )
    {
