...
public:
    ...
    bool Load(const wxURI& location, const wxURI& proxy) override;
    ...
    void Move([[maybe_unused]] wxRect boundary) override;
                                     ...
                                     const wxString& name)
{
    ...
    // bit smoother
    m_ctrl->SetBackgroundStyle(wxBackgroundStyle::Paint);
...
//---------------------------------------------------------------------------
void wxAMMediaBackend::Move([[maybe_unused]] wxRect boundary)
{
}
