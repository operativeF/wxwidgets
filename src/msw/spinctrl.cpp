...
bool wxSpinCtrl::ProcessTextCommand(WXWORD cmd, [[maybe_unused]] WXWORD id)
{
...
bool wxSpinCtrl::MSWOnScroll([[maybe_unused]] int orientation, WXWORD wParam,
...
bool wxSpinCtrl::MSWOnNotify([[maybe_unused]] int idCtrl, WXLPARAM lParam, WXLPARAM *result)
{
