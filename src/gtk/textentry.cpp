...
public:
    ...
    bool ChangeStrings(const wxArrayString& strings) override
    {
    ...
    bool ChangeCompleter(wxTextCompleter*) override
    {
        return false;
    }
...
public:
    ...
    bool ChangeStrings(const wxArrayString&) override
    {
        return false;
    }

    // Takes ownership of the pointer which must be non-NULL.
    bool ChangeCompleter(wxTextCompleter *completer) override
    {
        delete m_completer;
