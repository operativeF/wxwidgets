...
////@begin wxRichTextBulletsPage content construction
    ...
    itemBoxSizer5->Add(m_styleListBox, 1, wxStretch::Grow|wxDirection::All, 5);

    wxBoxSizer* itemBoxSizer8 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer5->Add(itemBoxSizer8, 0, wxStretch::Grow, 5);
    ...
    itemBoxSizer8->Add(m_periodCtrl, 0, wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemBoxSizer8->Add(m_parenthesesCtrl, 0, wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemBoxSizer8->Add(m_rightParenthesisCtrl, 0, wxAlignment::CenterVertical|wxDirection::All, 5);

    itemBoxSizer5->Add(5, 5, 0, wxAlignment::CenterHorizontal, 5);
    ...
    itemBoxSizer5->Add(itemStaticText13, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);
    ...
    m_bulletAlignmentCtrl = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTBULLETSPAGE_BULLETALIGNMENTCTRL, _("Left"), wxDefaultPosition, wxSize(60, -1), m_bulletAlignmentCtrlStrings, ComboStyles::ReadOnly );
    ...
    itemBoxSizer5->Add(m_bulletAlignmentCtrl, 0, wxStretch::Grow|wxDirection::All|wxFIXED_MINSIZE, 5);
    ...
    itemBoxSizer4->Add(itemStaticLine16, 0, wxStretch::Grow|wxDirection::Left|wxDirection::Right, 5);
    ...
    itemBoxSizer18->Add(itemBoxSizer19, 0, wxStretch::Grow, 5);
    ...
    itemBoxSizer19->Add(itemStaticText20, 0, wxAlignment::CenterVertical|wxDirection::All, 5);

    std::vector<std::string> m_symbolCtrlStrings;
    m_symbolCtrl = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTBULLETSPAGE_SYMBOLCTRL, "", wxDefaultPosition, wxSize(60, -1), m_symbolCtrlStrings, ComboStyles::DropDown );
    m_symbolCtrl->SetHelpText(_("The bullet character."));
    if (wxRichTextBulletsPage::ShowToolTips())
        m_symbolCtrl->SetToolTip(_("The bullet character."));
    itemBoxSizer19->Add(m_symbolCtrl, 0, wxAlignment::CenterVertical|wxDirection::All|wxFIXED_MINSIZE, 5);
    ...
    itemBoxSizer19->Add(itemButton22, 0, wxAlignment::CenterVertical|wxDirection::All, 5);

    itemBoxSizer18->Add(5, 5, 0, wxAlignment::CenterHorizontal, 5);
    ...
    itemBoxSizer18->Add(itemStaticText24, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);

    std::vector<std::string> m_symbolFontCtrlStrings;
    m_symbolFontCtrl = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTBULLETSPAGE_SYMBOLFONTCTRL, "", wxDefaultPosition, wxDefaultSize, m_symbolFontCtrlStrings, ComboStyles::DropDown );
    m_symbolFontCtrl->SetHelpText(_("Available fonts."));
    if (wxRichTextBulletsPage::ShowToolTips())
        m_symbolFontCtrl->SetToolTip(_("Available fonts."));
    itemBoxSizer18->Add(m_symbolFontCtrl, 0, wxStretch::Grow|wxDirection::All, 5);

    itemBoxSizer18->Add(5, 5, 1, wxAlignment::CenterHorizontal, 5);
    ...
    itemBoxSizer18->Add(itemStaticText27, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);

    std::vector<std::string> m_bulletNameCtrlStrings;
    m_bulletNameCtrl = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTBULLETSPAGE_NAMECTRL, "", wxDefaultPosition, wxDefaultSize, m_bulletNameCtrlStrings, ComboStyles::DropDown );
    m_bulletNameCtrl->SetHelpText(_("A standard bullet name."));
    if (wxRichTextBulletsPage::ShowToolTips())
        m_bulletNameCtrl->SetToolTip(_("A standard bullet name."));
    itemBoxSizer18->Add(m_bulletNameCtrl, 0, wxStretch::Grow|wxDirection::All, 5);
    ...
    itemBoxSizer18->Add(itemStaticText30, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);
    ...
    itemBoxSizer18->Add(m_numberCtrl, 0, wxStretch::Grow|wxDirection::All, 5);

    itemBoxSizer3->Add(5, 5, 0, wxAlignment::CenterHorizontal, 5);

    m_previewCtrl = new wxRichTextCtrl( itemRichTextDialogPage1, ID_RICHTEXTBULLETSPAGE_PREVIEW_CTRL, "", wxDefaultPosition, wxSize(350, 100), wxBorder::Theme|wxVSCROLL|wxTE_READONLY );
