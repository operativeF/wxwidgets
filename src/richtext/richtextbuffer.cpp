...
wxRichTextParagraphLayoutBox* wxRichTextObject::GetContainer() const
{
    ...
    while (p)
    {
        if (p->IsTopLevel())
        {
            return dynamic_cast<wxRichTextParagraphLayoutBox*>(p);
        }
        p = p->GetParent();
    }
    return nullptr;
...
bool wxRichTextObject::DrawBoxAttributes(wxDC& dc, wxRichTextBuffer* buffer, const wxRichTextAttr& attr, const wxRect& boxRect, unsigned int flags, wxRichTextObject* obj)
{
    ...
    if (flags & wxRICHTEXT_DRAW_GUIDELINES)
    {
        ...
        if (obj)
        {
            wxRichTextCell* cell = dynamic_cast<wxRichTextCell*>(obj);
            if (cell)
            {
...
wxRichTextBuffer* wxRichTextObject::GetBuffer() const
{
    ...
    while (obj && !dynamic_cast<wxRichTextBuffer*>(obj))
        obj = obj->GetParent();
    return dynamic_cast<wxRichTextBuffer*>(obj);
}
...
bool wxRichTextCompositeObject::Defragment(wxRichTextDrawingContext& context, const wxRichTextRange& range)
{
    ...
    while (node)
    {
        ...
        {
            wxRichTextCompositeObject* composite = dynamic_cast<wxRichTextCompositeObject*>(child);
            if (composite)
            {
...
bool wxRichTextParagraphLayoutBox::Layout(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style)
{
        ...
        if (invalidRange.GetStart() >= GetOwnRange().GetStart())
    {
        ...
        if (firstParagraph)
        {
            ...
            if (firstNode)
            {
                if (previousNode)
                {
                    wxRichTextParagraph* previousParagraph = dynamic_cast<wxRichTextParagraph*>(previousNode->GetData());
    ...
    while (n && n != node)
    {
        wxRichTextParagraph* child = dynamic_cast<wxRichTextParagraph*>(n->GetData());
        if (child)
        {
        ...
        if (child && child->IsShown())
        {
            ...
            else
            {
                ...
                if (wxRichTextBuffer::GetFloatingLayoutMode())
                {
                    while (node)
                    {
                        child = dynamic_cast<wxRichTextParagraph*>(node->GetData());
                        if (child)
                        {
                ...
                while (node)
                {
                    wxRichTextParagraph* nodeChild = dynamic_cast<wxRichTextParagraph*>(node->GetData());
                    if (nodeChild)
                    {
        ...
        (attr.GetTextBoxAttr().GetVerticalAlignment() > wxTEXT_BOX_ATTR_VERTICAL_ALIGNMENT_TOP))
    {
        ...
        if (yOffset != 0)
        {
            ...
            while (childNode)
            {
                wxRichTextParagraph* child = dynamic_cast<wxRichTextParagraph*>(childNode->GetData());
                if (child)
...
wxRichTextLine* wxRichTextParagraphLayoutBox::GetLineAtPosition(long pos, bool caretPosition) const
{
    ...
    while (node)
    {
        ...
        {
            // child is a paragraph
            wxRichTextParagraph* child = dynamic_cast<wxRichTextParagraph*>(obj);
            // wxASSERT (child != NULL);
...
bool wxRichTextParagraphLayoutBox::InsertFragment(long position, wxRichTextParagraphLayoutBox& fragment)
{
    ...
    if (para)
    {
        ...
        if (fragment.GetPartialParagraph() && fragment.GetChildren().GetCount() == 1)
        {
            ...
            wxRichTextParagraph* firstPara = dynamic_cast<wxRichTextParagraph*>(firstParaNode->GetData());
        ...
        else
        {
            ...
            while (i)
            {
                wxRichTextParagraph* searchPara = dynamic_cast<wxRichTextParagraph*>(i->GetData());
...
bool wxRichTextParagraphLayoutBox::CopyFragment(const wxRichTextRange& range, wxRichTextParagraphLayoutBox& fragment)
{
    ...
    while (i)
    {
        wxRichTextParagraph* para = dynamic_cast<wxRichTextParagraph*>(i->GetData());
    ...
    if (!fragment.IsEmpty())
    {
        wxRichTextParagraph* firstPara = dynamic_cast<wxRichTextParagraph*>(fragment.GetChildren().GetFirst()->GetData());
        wxASSERT( firstPara != nullptr );

        wxRichTextParagraph* lastPara = dynamic_cast<wxRichTextParagraph*>(fragment.GetChildren().GetLast()->GetData());
...
bool wxRichTextParagraphLayoutBox::DeleteRange(const wxRichTextRange& range)
{
    ...
    while (node)
    {
        wxRichTextParagraph* obj = dynamic_cast<wxRichTextParagraph*>(node->GetData());
        // wxASSERT (obj != NULL);
            ...
            if (!obj->GetRange().IsOutside(range))
            {
                ...
                if (range.GetEnd() <= thisRange.GetEnd())
                {
                    ...
                    else
                    {
                        ...
                        if (next)
                            nextParagraph = dynamic_cast<wxRichTextParagraph*>(next->GetData());
                    }
...
bool wxRichTextParagraphLayoutBox::DoGetStyle(long position, wxRichTextAttr& style, bool combineStyles)
{
    ...
    else
    {
        ...
        if (obj)
        {
            if (combineStyles)
            {
                wxRichTextParagraph* para = dynamic_cast<wxRichTextParagraph*>(obj->GetParent());
        ...
        if (para)
        {
            ...
            if (!para->GetRange().IsOutside(range))
            {
                ...
                while (node2)
                {
                    ...
                    if (!childRange.IsOutside(range) && dynamic_cast<wxRichTextPlainText*>(child))
                    {
                        foundCount ++;
...
void wxRichTextParagraphLayoutBox::InvalidateHierarchy(const wxRichTextRange& invalidRange)
{
    ...
    if (invalidRange != wxRICHTEXT_NONE)
    {
        ...
        while (p)
        {
            wxRichTextParagraphLayoutBox* l = dynamic_cast<wxRichTextParagraphLayoutBox*>(p);
            if (l)
...
bool wxRichTextParagraphLayoutBox::SetListStyle(const wxRichTextRange& range, const wxString& defName, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
bool wxRichTextParagraphLayoutBox::NumberList(const wxRichTextRange& range, const wxString& defName, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
bool wxRichTextParagraphLayoutBox::PromoteList(int promoteBy, const wxRichTextRange& range, const wxString& defName, unsigned int flags, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
    if (buffer->GetStyleSheet())
    {
...
bool wxRichTextParagraphLayoutBox::FindNextParagraphNumber(wxRichTextParagraph* previousParagraph, wxRichTextAttr& attr) const
{
    ...
    while (previousParagraph && previousParagraph->GetAttributes().HasBulletStyle() && previousParagraph->GetAttributes().GetBulletStyle() & wxTEXT_ATTR_BULLET_STYLE_CONTINUATION)
    {
        ...
        if (node)
        {
            ...
            if (node)
                previousParagraph = dynamic_cast<wxRichTextParagraph*>(node->GetData());
            else
...
bool wxRichTextParagraph::Layout(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style)
{
    ...
    // use as the minimum.
    {
        ...
        while (node)
        {
            ...
            // Also ignore if empty object, except if we haven't got any
            // size yet.
            if ((!child->IsFloating() || !wxRichTextBuffer::GetFloatingLayoutMode()) && child->GetRange().GetLength() != 0 && !dynamic_cast<wxRichTextPlainText*>(child))
            {
...
bool wxRichTextParagraph::InsertText(long pos, const wxString& text)
{
    ...
    if (childToUse)
    {
        wxRichTextPlainText* textObject = dynamic_cast<wxRichTextPlainText*>(childToUse);
        if (textObject)
        {
...
bool wxRichTextParagraph::FindPosition(wxDC& dc, wxRichTextDrawingContext& context, long index, wxPoint& pt, int* height, bool forceLineStart)
{
    ...
    {
        wxRichTextParagraphLayoutBox* parent = dynamic_cast<wxRichTextParagraphLayoutBox*>(GetParent());
...
{
    wxRichTextAttr attr;
    wxRichTextParagraphLayoutBox* buf = dynamic_cast<wxRichTextParagraphLayoutBox*>(GetParent());
    if (buf)
    {
...
{
    wxRichTextParagraph* para = dynamic_cast<wxRichTextParagraph*>(GetParent());
    wxASSERT (para != nullptr);
...
bool wxRichTextPlainText::CanMerge(wxRichTextObject* object, wxRichTextDrawingContext& context) const
{
    ...
    {
        wxRichTextPlainText* otherObj = dynamic_cast<wxRichTextPlainText*>(object);
...
{
    wxRichTextPlainText* textObject = dynamic_cast<wxRichTextPlainText*>(object);
...
wxRichTextObject* wxRichTextPlainText::Split(wxRichTextDrawingContext& context)
{
    ...
    {
        wxRichTextCompositeObject* parent = dynamic_cast<wxRichTextCompositeObject*>(GetParent());
...
bool wxRichTextBuffer::InsertTextWithUndo(long pos, const wxString& text, wxRichTextCtrl* ctrl, unsigned int flags)
{
    if (ctrl)
...
/// Submit command to insert the given text
bool wxRichTextParagraphLayoutBox::InsertTextWithUndo(wxRichTextBuffer* buffer, long pos, const wxString& text, wxRichTextCtrl* ctrl, unsigned int flags)
{
    wxRichTextAction* action = new wxRichTextAction(nullptr, _("Insert Text"), wxRICHTEXT_INSERT, buffer, this, ctrl, false);
                                                        ...
                                                        const wxRichTextAttr& textAttr)
{
    ...
    wxRichTextField* obj = dynamic_cast<wxRichTextField*>(GetLeafObjectAtPosition(pos));
    return obj;
}
...
bool wxRichTextCell::AdjustAttributes(wxRichTextAttr& attr, wxRichTextDrawingContext& context)
{
    ...
    wxRichTextTable* table = dynamic_cast<wxRichTextTable*>(GetParent());
...
void wxRichTextTable::Copy(const wxRichTextTable& obj)
{
    ...
    for (i = 0; i < m_rowCount; i++)
    {
        ...
        for (j = 0; j < m_colCount; j++)
        {
            wxRichTextCell* cell = dynamic_cast<wxRichTextCell*>(obj.GetCell(i, j)->Clone());
            AppendChild(cell);
...
wxRichTextCell* wxRichTextTable::GetCell(int row, int col) const
{
    ...
    if (row < m_rowCount && col < m_colCount)
    {
        ...
        return dynamic_cast<wxRichTextCell*>(obj);
    }
    else
        return nullptr;
}
...
bool wxRichTextTable::SetCellStyle(const wxRichTextSelection& selection, const wxRichTextAttr& style, unsigned int flags)
{
    ...
    while (node)
    {
        wxRichTextCell* cell = dynamic_cast<wxRichTextCell*>(node->GetData());
...
bool wxRichTextTableBlock::ComputeBlockForSelection(wxRichTextTable* table, wxRichTextCtrl* ctrl, bool requireCellSelection)
{
    ...
    else
    {
        ...
        wxRichTextCell* cell = dynamic_cast<wxRichTextCell*>(ctrl->GetFocusObject());
...
{
    wxRichTextParagraphLayoutBox* container = dynamic_cast<wxRichTextParagraphLayoutBox*>(GetContainerAddress().wxGetObject(m_buffer));
    return container;
}
    ...
    case wxRICHTEXT_CHANGE_OBJECT:
        {
            ...
            if (obj && m_object && m_ctrl)
            {
                ...
                wxRichTextCompositeObject* parent = dynamic_cast<wxRichTextCompositeObject*>(obj->GetParent());
...
wxRichTextObject* wxRichTextObjectAddress::wxGetObject(wxRichTextParagraphLayoutBox* topLevelContainer) const
{
    ...
    while (p && i < m_address.size())
    {
        ...
        p = dynamic_cast<wxRichTextCompositeObject*>(p1);
        i ++;
    }
    return nullptr;
}
...
bool wxRichTextObjectAddress::Create(wxRichTextParagraphLayoutBox* topLevelContainer, wxRichTextObject* obj)
{
    ...
    while (o)
    {
        wxRichTextCompositeObject* p = dynamic_cast<wxRichTextCompositeObject*>(o->GetParent());
        if (!p)
            return false;
