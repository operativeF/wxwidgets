...
public:
    ...
    void Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style);

    // HitTest the floats
    int HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags);
    ...
    static void DrawFloat(const wxRichTextFloatRectMapArray& array, wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style);

    static int HitTestFloat(const wxRichTextFloatRectMapArray& array, wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags);
...
void wxRichTextFloatCollector::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
    if (m_left.GetCount() > 0)
...
int wxRichTextFloatCollector::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
...
bool wxRichTextObject::DrawBoxAttributes(wxDC& dc, wxRichTextBuffer* buffer, const wxRichTextAttr& attr, const wxRect& boxRect, unsigned int flags, wxRichTextObject* obj)
{
    ...
    if (attr.GetTextBoxAttr().GetShadow().IsValid())
    {
        ...
        if (attr.GetTextBoxAttr().GetShadow().GetOpacity().IsValid())
        {
            ...
            shadowColour.Set(std::lround((1.0 - p)*255 + p*shadowColour.Red()),
                             std::lround((1.0 - p)*255 + p*shadowColour.Green()),
                             std::lround((1.0 - p)*255 + p*shadowColour.Blue()));
        }
...
void wxRichTextObject::Dump(wxTextOutputStream& stream)
{
    ...
    stream << fmt::format("Size: %d,%d. Position: %d,%d, Range: %ld,%ld", m_size.x, m_size.y, m_pos.x, m_pos.y, m_range.GetStart(), m_range.GetEnd()) << "\n";
    stream << fmt::format("Text colour: %d,%d,%d.", (int) m_attributes.GetTextColour().Red(), (int) m_attributes.GetTextColour().Green(), (int) m_attributes.GetTextColour().Blue()) << wxT("\n");
}
...
/// Hit-testing: returns a flag indicating hit test details, plus
/// information about position
int wxRichTextCompositeObject::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
    if (!IsShown())
        return wxRICHTEXT_HITTEST_NONE;
...
std::string wxRichTextCompositeObject::GetTextForRange(const wxRichTextRange& range) const
{
    std::string text;
    wxRichTextObjectList::compatibility_iterator node = m_children.GetFirst();
    while (node)
    {
        ...
        if (!child->GetRange().IsOutside(range))
        {
            ...
            std::string childText = child->GetTextForRange(childRange);
...
bool wxRichTextCompositeObject::GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int flags, const wxPoint& position, const wxSize& parentSize, std::vector<int>* partialExtents) const
{
...
// HitTest
int wxRichTextParagraphLayoutBox::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
    if (!IsShown())
        return wxRICHTEXT_HITTEST_NONE;
...
void wxRichTextParagraphLayoutBox::DrawFloats(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
...
/// Draw the item
bool wxRichTextParagraphLayoutBox::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
...
/// Lay the item out
bool wxRichTextParagraphLayoutBox::Layout(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style)
{
...
wxRichTextRange wxRichTextParagraphLayoutBox::AddParagraph(const std::string& text, wxRichTextAttr* paraStyle)
{
...
wxRichTextRange wxRichTextParagraphLayoutBox::AddParagraphs(const std::string& text, wxRichTextAttr* paraStyle)
{
    // Don't use the base style, just the default style, and the base style will
    // be combined at display time.
    // Divide into paragraph and character styles.
...
/// Get any text in this object for the given range
std::string wxRichTextParagraphLayoutBox::GetTextForRange(const wxRichTextRange& range) const
{
    int lineCount = 0;
    std::string text;
    wxRichTextObjectList::compatibility_iterator node = m_children.GetFirst();
...
/// Get all the text
std::string wxRichTextParagraphLayoutBox::GetText() const
{
...
std::string wxRichTextParagraphLayoutBox::GetParagraphText(long paragraphNumber) const
{
    wxRichTextParagraph* para = GetParagraphAtLine(paragraphNumber);
    if (para)
...
bool wxRichTextParagraphLayoutBox::SetStyle(const wxRichTextRange& range, const wxRichTextAttr& style, unsigned int flags)
{
...
void wxRichTextParagraphLayoutBox::SetStyle(wxRichTextObject* obj, const wxRichTextAttr& textAttr, unsigned int flags)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
constexpr bool wxHasStyle(long flags, unsigned int style)
{
    ...
    while (node)
    {
        ...
        if (para)
        {
            ...
            if (!para->GetRange().IsOutside(range))
            {
                ...
                // only the attributes.
                unsigned int flags = wxTEXT_ATTR_AVOID_PAGE_BREAK_BEFORE|wxTEXT_ATTR_AVOID_PAGE_BREAK_AFTER|wxTEXT_ATTR_PAGE_BREAK;
...
bool wxRichTextParagraphLayoutBox::SetProperties(const wxRichTextRange& range, const wxRichTextProperties& properties, unsigned int flags)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
/// Set list style
bool wxRichTextParagraphLayoutBox::SetListStyle(const wxRichTextRange& range, wxRichTextListStyleDefinition* def, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
bool wxRichTextParagraphLayoutBox::SetListStyle(const wxRichTextRange& range, const std::string& defName, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
bool wxRichTextParagraphLayoutBox::ClearListStyle(const wxRichTextRange& range, unsigned int flags)
{
    return SetListStyle(range, nullptr, flags);
}

/// Number/renumber any list elements in the given range
bool wxRichTextParagraphLayoutBox::NumberList(const wxRichTextRange& range, wxRichTextListStyleDefinition* def, unsigned int flags, int startFrom, int specifiedLevel)
{
...
bool wxRichTextParagraphLayoutBox::DoNumberList(const wxRichTextRange& range, const wxRichTextRange& promotionRange, int promoteBy,
                                                wxRichTextListStyleDefinition* def, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
    wxRichTextStyleSheet* styleSheet = buffer->GetStyleSheet();
...
bool wxRichTextParagraphLayoutBox::NumberList(const wxRichTextRange& range, const std::string& defName, unsigned int flags, int startFrom, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
...
bool wxRichTextParagraphLayoutBox::PromoteList(int promoteBy, const wxRichTextRange& range, wxRichTextListStyleDefinition* def, unsigned int flags, int specifiedLevel)
{
    // TODO
...
bool wxRichTextParagraphLayoutBox::PromoteList(int promoteBy, const wxRichTextRange& range, const std::string& defName, unsigned int flags, int specifiedLevel)
{
    wxRichTextBuffer* buffer = GetBuffer();
    if (buffer->GetStyleSheet())
    {
...
bool wxRichTextParagraphLayoutBox::FindNextParagraphNumber(wxRichTextParagraph* previousParagraph, wxRichTextAttr& attr) const
{
    ...
    if (styleSheet && !previousParagraph->GetAttributes().GetListStyleName().IsEmpty())
    {
        ...
        if (def)
        {
            ...
            if (isOutline)
            {
                std::string text = previousParagraph->GetAttributes().GetBulletText();
                if (!text.empty())
                {
                    auto pos = text.rfind('.');
                    if (pos != std::string::npos)
                    {
                        text = text.substr(0, text.length() - pos - 1);
                    }
                    else
                        text.clear();
                    if (!text.empty())
                        text += '.';
                    text += fmt::format("%d", nextNumber);
...
wxRichTextParagraph::wxRichTextParagraph(const std::string& text, wxRichTextObject* parent, wxRichTextAttr* paraStyle, wxRichTextAttr* charStyle):
    wxRichTextCompositeObject(parent)
{
    if (paraStyle)
    ...
    {
        {
            ...
            wxRichTextLine* line = m_cachedLines.GetFirst() ? (wxRichTextLine* ) m_cachedLines.GetFirst()->GetData() : nullptr;
            ...
            {
                std::string bulletText = GetBulletText();
...
/// Lay the item out
bool wxRichTextParagraph::Layout(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style)
{
    ...
    std::size_t lastEndPos = GetRange().GetStart() - 1;
    std::size_t lastCompletedEndPos = lastEndPos;
...
bool wxRichTextParagraph::InsertText(long pos, const std::string& text)
{
    ...
    if (childToUse)
    {
        ...
        if (textObject)
        {
            ...
            std::string newText = textObject->GetText().substr(0, posInString) +
                               text + textObject->GetText().substr(posInString);
...
/// Get/set the object size for the given range. Returns false if the range
/// is invalid for this object.
bool wxRichTextParagraph::GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int flags, const wxPoint& position, const wxSize& parentSize, std::vector<int>* partialExtents) const
{
    if (!range.IsWithin(GetRange()))
        return false;
...
/// Hit-testing: returns a flag indicating hit test details, plus
/// information about position
int wxRichTextParagraph::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
    if (!IsShown())
        return wxRICHTEXT_HITTEST_NONE;
...
bool wxRichTextParagraph::GetContiguousPlainText(std::string& text, const wxRichTextRange& range, bool fromStart)
{
    text.clear();
...
bool wxRichTextParagraph::FindWrapPosition(const wxRichTextRange& range, wxDC& dc, wxRichTextDrawingContext& context, int availableSpace, std::size_t& wrapPosition, std::vector<int>* partialExtents)
{
    ...
    wxSize sz;
    std::size_t breakPosition = range.GetEnd();
    ...
    if (partialExtents && partialExtents->size() >= (size_t) (GetRange().GetLength()-1)) // the final position in a paragraph is the newline
    {
        ...
        for (std::size_t i = range.GetStart(); i <= (size_t) range.GetEnd(); i++)
        {
    ...
    {
        auto newLinePos = plainText.find(wxRichTextLineBreakChar);
        if (newLinePos != std::string::npos)
        {
            breakPosition = range.GetStart() + newLinePos;
        }
        else
        {
            auto spacePos = plainText.rfind(' ');
            auto tabPos = plainText.rfind('\t');
            auto pos = std::max(spacePos, tabPos);
            if (pos != std::string::npos)
            {
...
std::string wxRichTextParagraph::GetBulletText()
{
...
void wxRichTextParagraph::LayoutFloat(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style, wxRichTextFloatCollector* floatCollector)
{
...
wxRichTextPlainText::wxRichTextPlainText(const std::string& text, wxRichTextObject* parent, wxRichTextAttr* style):
    wxRichTextObject(parent)
{
    if (style)
        SetAttributes(*style);
...
bool wxRichTextPlainText::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int WXUNUSED(style))
{
    ...
    wx::utils::ReplaceAll(str, std::string{wxRichTextLineBreakChar}, " ");
    ...
    std::string stringChunk = str.substr(range.GetStart() - offset, len);
    ...
    else
    {
        ...
        if (selectionRange.GetStart() > range.GetStart() && selectionRange.GetStart() <= range.GetEnd())
        {
            ...
            std::string stringFragment = str.substr(r1 - offset, fragmentLen);
            ...
            if (stringChunk.find('\t') == std::string::npos)
            {
                ...
                std::string stringFragment2(str.substr(r1 - offset, fragmentLen+1));
                std::string stringFragment3(str.substr(r1 - offset + fragmentLen, 1));
        ...
        if (selectionRange.GetEnd() >= range.GetStart())
        {
            ...
            std::string stringFragment = str.substr(s1 - offset, fragmentLen);
            ...
            {
                // Compensate for kerning difference
                std::string stringFragment2(str.substr(s1 - offset, fragmentLen+1));
                std::string stringFragment3(str.substr(s1 - offset + fragmentLen, 1));
        ...
        if (selectionRange.GetEnd() < range.GetEnd())
        {
            ...
            std::string stringFragment = str.substr(s2 - offset, fragmentLen);
...
bool wxRichTextPlainText::GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int WXUNUSED(flags), const wxPoint& position, const wxSize& WXUNUSED(parentSize), std::vector<int>* partialExtents) const
{
    ...
    std::size_t len = range.GetLength();
    ...
    std::string stringChunk = str.substr(startPos, len);
    ...
    if (!stringChunk.empty())
    {
        ...
        {
            width += dc.GetTextExtent(stringChunk, &descent).x;
            haveDescent = true;
        }
    }
...
wxRichTextObject* wxRichTextPlainText::DoSplit(long pos)
{
    ...
    std::string firstPart = m_text.substr(0, index);
    std::string secondPart = m_text.substr(index);
...
bool wxRichTextPlainText::DeleteRange(const wxRichTextRange& range)
{
    ...
    m_text = m_text.substr(0, startIndex + len);
    return true;
}

/// Get text for the given range.
std::string wxRichTextPlainText::GetTextForRange(const wxRichTextRange& range) const
{
    wxRichTextRange r = range;

    r.LimitTo(GetRange());

    auto startIndex = r.GetStart() - GetRange().GetStart();
                        ...
                        else if ((pos-1) > runEnd)
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        lastPlainText = this;
                                        SetText(text.substr(runStart, runEnd - runStart + 1));
                                    }
                                    else
                                    {
                                        ...
                                        obj->SetText(text.substr(runStart, runEnd - runStart + 1));
                                        if (next)
...
bool wxRichTextBuffer::InsertParagraphsWithUndo(long pos, const wxRichTextParagraphLayoutBox& paragraphs, wxRichTextCtrl* ctrl, unsigned int flags)
{
...
bool wxRichTextBuffer::InsertTextWithUndo(long pos, const std::string& text, wxRichTextCtrl* ctrl, unsigned int flags)
{
    if (ctrl)
...
/// Submit command to insert the given text
bool wxRichTextParagraphLayoutBox::InsertTextWithUndo(wxRichTextBuffer* buffer, long pos, const std::string& text, wxRichTextCtrl* ctrl, unsigned int flags)
{
    wxRichTextAction* action = new wxRichTextAction(nullptr, _("Insert Text"), wxRICHTEXT_INSERT, buffer, this, ctrl, false);
...
/// Submit command to insert the given text
bool wxRichTextBuffer::InsertNewlineWithUndo(long pos, wxRichTextCtrl* ctrl, unsigned int flags)
{
    return ctrl->GetFocusObject()->InsertNewlineWithUndo(this, pos, ctrl, flags);
}

/// Submit command to insert the given text
bool wxRichTextParagraphLayoutBox::InsertNewlineWithUndo(wxRichTextBuffer* buffer, long pos, wxRichTextCtrl* ctrl, unsigned int flags)
{
    wxRichTextAction* action = new wxRichTextAction(nullptr, _("Insert Text"), wxRICHTEXT_INSERT, buffer, this, ctrl, false);
...
bool wxRichTextBuffer::InsertImageWithUndo(long pos, const wxRichTextImageBlock& imageBlock, wxRichTextCtrl* ctrl, unsigned int flags,
...
wxRichTextObject* wxRichTextBuffer::InsertObjectWithUndo(long pos, wxRichTextObject *object, wxRichTextCtrl* ctrl, unsigned int flags)
{
    return ctrl->GetFocusObject()->InsertObjectWithUndo(this, pos, object, ctrl, flags);
}

// Insert an object with no change of it
wxRichTextObject* wxRichTextParagraphLayoutBox::InsertObjectWithUndo(wxRichTextBuffer* buffer, long pos, wxRichTextObject *object, wxRichTextCtrl* ctrl, unsigned int flags)
{
...
wxRichTextField* wxRichTextParagraphLayoutBox::InsertFieldWithUndo(wxRichTextBuffer* buffer, long pos, const std::string& fieldType,
...
bool wxRichTextBuffer::BeginBatchUndo(const std::string& cmdName)
{
...
/// Begin symbol bullet
bool wxRichTextBuffer::BeginSymbolBullet(const std::string& symbol, int leftIndent, int leftSubIndent, int bulletStyle)
{
    wxRichTextAttr attr;
    attr.SetFlags(wxTEXT_ATTR_BULLET_STYLE|wxTEXT_ATTR_LEFT_INDENT);
    attr.SetBulletStyle(bulletStyle);
...
bool wxRichTextBuffer::BeginStandardBullet(const std::string& bulletName, int leftIndent, int leftSubIndent, int bulletStyle)
{
    wxRichTextAttr attr;
    attr.SetFlags(wxTEXT_ATTR_BULLET_STYLE|wxTEXT_ATTR_LEFT_INDENT);
    attr.SetBulletStyle(bulletStyle);
...
bool wxRichTextBuffer::BeginCharacterStyle(const std::string& characterStyle)
{
    if (GetStyleSheet())
    {
...
bool wxRichTextBuffer::BeginParagraphStyle(const std::string& paragraphStyle)
{
    if (GetStyleSheet())
    {
...
bool wxRichTextBuffer::BeginListStyle(const std::string& listStyle, int level, int number)
{
    if (GetStyleSheet())
    {
...
/// Begin URL
bool wxRichTextBuffer::BeginURL(const std::string& url, const std::string& characterStyle)
{
    wxRichTextAttr attr;

    if (!characterStyle.empty() && GetStyleSheet())
    {
        wxRichTextCharacterStyleDefinition* def = GetStyleSheet()->FindCharacterStyle(characterStyle);
        if (def)
        {
...
/// Removes a handler
bool wxRichTextBuffer::RemoveHandler(const std::string& name)
{
...
wxRichTextFileHandler *wxRichTextBuffer::FindHandlerFilenameOrType(const fs::path& filename,
...
wxRichTextFileHandler* wxRichTextBuffer::FindHandler(const std::string& name)
{
    wxList::compatibility_iterator node = sm_handlers.GetFirst();
    while (node)
    {
        wxRichTextFileHandler *handler = (wxRichTextFileHandler*)node->GetData();
        if (wx::utils::ToLowerCopy(handler->GetName()) == wx::utils::ToLowerCopy(name)) return handler;
...
wxRichTextFileHandler* wxRichTextBuffer::FindHandler(const std::string& extension, wxRichTextFileType type)
{
    wxList::compatibility_iterator node = sm_handlers.GetFirst();
    while (node)
    {
        wxRichTextFileHandler *handler = (wxRichTextFileHandler*)node->GetData();
        if ( wx::utils::ToLowerCopy(handler->GetExtension()) == wx::utils::ToLowerCopy(extension) &&
...
std::string wxRichTextBuffer::GetExtWildcard(bool combine, bool save, std::vector<int>* types)
{
    if (types)
        types->clear();
...
/// Load a file
bool wxRichTextBuffer::LoadFile(const std::string& filename, wxRichTextFileType type)
{
...
/// Save a file
bool wxRichTextBuffer::SaveFile(const std::string& filename, wxRichTextFileType type)
{
    wxRichTextFileHandler* handler = FindHandlerFilenameOrType(filename, type);
    if (handler)
    {
...
bool wxRichTextBuffer::CopyToClipboard(const wxRichTextRange& range)
{
    ...
    if (!wxTheClipboard->IsOpened() && wxTheClipboard->Open())
    {
        ...
        {
            std::string text = container->GetTextForRange(range);
...
/// Hit-testing: returns a flag indicating hit test details, plus
/// information about position
int wxRichTextBuffer::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
...
bool wxRichTextStdRenderer::DrawTextBullet(wxRichTextParagraph* paragraph, wxDC& dc, const wxRichTextAttr& attr, const wxRect& rect, const std::string& text)
{
    if (!text.empty())
    {
...
/// Draw the item
bool wxRichTextBox::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
    if (!IsShown())
        return true;
...
wxRichTextField::wxRichTextField(const std::string& fieldType, wxRichTextObject* parent):
    wxRichTextParagraphLayoutBox(parent)
{
...
/// Draw the item
bool wxRichTextField::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
    if (!IsShown())
        return true;
    ...
    std::string fieldTypeStr(GetFieldType());
    wxRichTextFieldTypeStandard defaultFieldType;
    defaultFieldType.SetLabel(fmt::format("unknown field %s", fieldTypeStr));
    return defaultFieldType.Draw(this, dc, context, range, selection, rect, descent, style);
}

bool wxRichTextField::Layout(wxDC& dc, wxRichTextDrawingContext& context, const wxRect& rect, const wxRect& parentRect, unsigned int style)
{
    wxRichTextFieldType* fieldType = wxRichTextBuffer::FindFieldType(GetFieldType());
...
bool wxRichTextField::GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int flags, const wxPoint& position, const wxSize& parentSize, std::vector<int>* partialExtents) const
{
    wxRichTextFieldType* fieldType = wxRichTextBuffer::FindFieldType(GetFieldType());
    if (fieldType)
...
std::string wxRichTextField::GetPropertiesMenuLabel() const
{
    wxRichTextFieldType* fieldType = wxRichTextBuffer::FindFieldType(GetFieldType());
    if (fieldType)
...
wxRichTextFieldTypeStandard::wxRichTextFieldTypeStandard(const std::string& name, const std::string& label, int displayStyle)
{
    SetName(name);
    SetLabel(label);
...
wxRichTextFieldTypeStandard::wxRichTextFieldTypeStandard(const std::string& name, const wxBitmap& bitmap, int displayStyle)
{
    SetName(name);
    SetBitmap(bitmap);
    SetDisplayStyle(displayStyle);
...
bool wxRichTextFieldTypeStandard::GetRangeSize(wxRichTextField* obj, const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int flags, const wxPoint& position, const wxSize& parentSize, std::vector<int>* partialExtents) const
{
    if (IsTopLevel(obj))
...
wxSize wxRichTextFieldTypeStandard::GetSize(wxRichTextField* WXUNUSED(obj), wxDC& dc, wxRichTextDrawingContext& WXUNUSED(context), unsigned int WXUNUSED(style)) const
{
    ...
    if (m_bitmap.IsOk())
    {
        ...
        sz = wxSize(bitmapSize.x + m_horizontalMargin*2, bitmapSize.y + m_verticalMargin*2);
    }
    else
    {
        std::string label(m_label);
        ...
        sz = wxSize(textExtent.x + m_horizontalPadding * 2 + m_horizontalMargin * 2,
                    textExtent.y + m_verticalPadding * 2 + m_verticalMargin * 2);
    }
...
/// Draw the item
bool wxRichTextCell::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
    if (selection.IsValid() &&
...
int wxRichTextCell::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
    int ret = wxRichTextParagraphLayoutBox::HitTest(dc, context, pt, textPosition, obj, contextObj, flags);
    if (ret != wxRICHTEXT_HITTEST_NONE)
    {
...
// Draws the object.
bool wxRichTextTable::Draw(wxDC& dc, wxRichTextDrawingContext& context, const wxRichTextRange& range, const wxRichTextSelection& selection, const wxRect& rect, int descent, unsigned int style)
{
...
static
void ExpandCellsWithRowspan(const wxRichTextTable* table, int paddingY, int& bottomY, wxDC& dc, wxRichTextDrawingContext& context, const wxRect& availableSpace, unsigned int style)
{
...
// Gets the range size.
bool wxRichTextTable::GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, unsigned int flags, const wxPoint& position, const wxSize& parentSize, std::vector<int>* partialExtents) const
{
...
std::string wxRichTextTable::GetTextForRange(const wxRichTextRange& range) const
{
...
bool wxRichTextTable::SetCellStyle(const wxRichTextSelection& selection, const wxRichTextAttr& style, unsigned int flags)
{
...
int wxRichTextTable::HitTest(wxDC& dc, wxRichTextDrawingContext& context, const wxPoint& pt, long& textPosition, wxRichTextObject** obj, wxRichTextObject** contextObj, unsigned int flags)
{
    for (int row = 0; row < GetRowCount(); ++row)
    {
        for (int col = 0; col < GetColumnCount(); ++col)
...
wxRichTextCommand::wxRichTextCommand(const std::string& name, wxRichTextCommandId id, wxRichTextBuffer* buffer,
...
wxRichTextCommand::wxRichTextCommand(const std::string& name): wxCommand(true, name)
{
}
...
wxRichTextAction::wxRichTextAction(wxRichTextCommand* cmd, const std::string& name, wxRichTextCommandId id,
    ...
    case wxRICHTEXT_INSERT:
        {
            ...
            container->InvalidateHierarchy(wxRichTextRange(GetRange().GetStart() - 1, GetRange().GetEnd()));

            auto newCaretPosition = GetPosition() + m_newParagraphs.GetOwnRange().GetLength();
...
std::string wxRichTextDecimalToRoman(long n)
{
...
#if wxUSE_FFILE && wxUSE_STREAMS
bool wxRichTextFileHandler::LoadFile(wxRichTextBuffer *buffer, const std::string& filename)
{
...
bool wxRichTextFileHandler::SaveFile(wxRichTextBuffer *buffer, const std::string& filename)
{
...
bool wxRichTextFileHandler::CanHandle(const fs::path& filename) const
{
    return (wx::utils::ToLowerCopy(filename.extension().string()) == GetExtension());
}
...
bool wxRichTextPlainTextHandler::DoSaveFile(wxRichTextBuffer *buffer, wxOutputStream& stream)
{
    ...
    wx::utils::ReplaceAll(text, std::string{wxRichTextLineBreakChar}, "\n");

    wxCharBuffer buf = text.c_str();
...
bool wxRichTextImageBlock::MakeImageBlock(const std::string& filename, wxBitmapType imageType,
                                          wxImage& image, bool convertToJPEG)
{
    m_imageType = imageType;

    std::string filenameToRead(filename);
...
// Write to a file
bool wxRichTextImageBlock::Write(const std::string& filename)
{
...
#else
    std::string tempFile = wxFileName::CreateTempFileName(_("image"));
...
unsigned char* wxRichTextImageBlock::ReadBlock(const std::string& filename, size_t size)
{
...
bool wxRichTextImageBlock::WriteBlock(const std::string& filename, unsigned char* block, size_t size)
{
...
std::string wxRichTextImageBlock::GetExtension() const
{
...
bool wxRichTextBufferDataObject::GetDataHere(void *pBuf) const
{
    ...
    size_t len = bufXML.size();
    std::memcpy((char*) pBuf, bufXML.data(), len);
    ((char*) pBuf)[len] = 0;
...
bool wxRichTextBufferDataObject::SetData(size_t WXUNUSED(len), const void *buf)
{
    ...
    std::string bufXML((const char*) buf);
...
{
    std::string facename(fontSpec.GetFontFaceName());
    ...
    std::string spec = fmt::format("%d-%s-%d-%d-%d-%d-%s-%d",
...
void wxTextAttrBorders::SetStyle(unsigned int style)
{
...
void wxTextAttrCollectCommonAttributes(wxTextAttr& currentStyle, const wxTextAttr& attr, wxTextAttr& clashingAttr, wxTextAttr& absentAttr)
{
    ...
    if (attr.HasFontFaceName() && !wxHasStyle(forbiddenFlags, wxTEXT_ATTR_FONT_FACE))
    {
        ...
        {
            std::string faceName1(currentStyle.GetFontFaceName());
            std::string faceName2(attr.GetFontFaceName());
...
int wxRichTextProperties::Find(const std::string& name) const
{
    size_t i;
    for (i = 0; i < m_properties.GetCount(); i++)
    {
...
bool wxRichTextProperties::Remove(const std::string& name)
{
    int idx = Find(name);
    if (idx != -1)
    {
...
wxVariant* wxRichTextProperties::FindOrCreateProperty(const std::string& name)
{
    int idx = Find(name);
    if (idx == wxNOT_FOUND)
        SetProperty(name, std::string());
    idx = Find(name);
    if (idx != wxNOT_FOUND)
    {
        return & (*this)[idx];
...
const wxVariant& wxRichTextProperties::GetProperty(const std::string& name) const
{
...
std::string wxRichTextProperties::GetPropertyString(const std::string& name) const
{
    return GetProperty(name).GetString();
}

long wxRichTextProperties::GetPropertyLong(const std::string& name) const
{
    return GetProperty(name).GetLong();
}

bool wxRichTextProperties::GetPropertyBool(const std::string& name) const
{
    return GetProperty(name).GetBool();
}

double wxRichTextProperties::GetPropertyDouble(const std::string& name) const
{
...
void wxRichTextProperties::SetProperty(const std::string& name, const wxVariant& variant)
{
    int idx = Find(name);
...
void wxRichTextProperties::SetProperty(const std::string& name, const std::string& value)
{
    SetProperty(name, wxVariant(value, name));
}

void wxRichTextProperties::SetProperty(const std::string& name, long value)
{
    SetProperty(name, wxVariant(value, name));
}

void wxRichTextProperties::SetProperty(const std::string& name, double value)
{
    SetProperty(name, wxVariant(value, name));
}

void wxRichTextProperties::SetProperty(const std::string& name, bool value)
{
    SetProperty(name, wxVariant(value, name));
}
...
void wxRichTextProperties::RemoveProperties(const wxRichTextProperties& properties)
{
    ...
    {
        std::string name = properties.GetProperties()[i].GetName();
        if (HasProperty(name))
            Remove(name);
    }
}
...
bool wxRichTextDrawingContext::GetVirtualText(const wxRichTextPlainText* obj, std::string& text) const
{
    if (!GetVirtualAttributesEnabled())
        return false;
...
/// Removes a handler
bool wxRichTextBuffer::RemoveDrawingHandler(const std::string& name)
{
...
wxRichTextDrawingHandler* wxRichTextBuffer::FindDrawingHandler(const std::string& name)
{
...
bool wxRichTextBuffer::RemoveFieldType(const std::string& name)
{
...
wxRichTextFieldType *wxRichTextBuffer::FindFieldType(const std::string& name)
{
    wxRichTextFieldTypeHashMap::iterator it = sm_fieldTypes.find(name);
    if (it == sm_fieldTypes.end())
        return nullptr;
