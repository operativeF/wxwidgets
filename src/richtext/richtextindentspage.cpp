...
////@begin wxRichTextIndentsSpacingPage content construction
    ...
    itemBoxSizer5->Add(itemBoxSizer7, 0, wxAlignment::CenterHorizontal|wxDirection::All, 5);

    itemBoxSizer7->Add(5, 5, 0, wxAlignment::CenterVertical, 5);

    wxBoxSizer* itemBoxSizer9 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer7->Add(itemBoxSizer9, 0, wxAlignment::CenterVertical|wxDirection::Top, 5);
    ...
    itemBoxSizer9->Add(m_alignmentLeft, 0, wxAlignment::Left|wxDirection::All, 5);
    ...
    itemBoxSizer9->Add(m_alignmentRight, 0, wxAlignment::Left|wxDirection::All, 5);
    ...
    itemBoxSizer9->Add(m_alignmentJustified, 0, wxAlignment::Left|wxDirection::All, 5);
    ...
    itemBoxSizer9->Add(m_alignmentCentred, 0, wxAlignment::Left|wxDirection::All, 5);
    ...
    itemBoxSizer9->Add(m_alignmentIndeterminate, 0, wxAlignment::Left|wxDirection::All, 5);

    itemBoxSizer4->Add(2, 1, 1, wxAlignment::CenterVertical|wxDirection::Top|wxDirection::Bottom, 5);
    ...
    itemBoxSizer4->Add(itemStaticLine16, 0, wxStretch::Grow|wxDirection::Left|wxDirection::Bottom, 5);

    itemBoxSizer4->Add(2, 1, 1, wxAlignment::CenterVertical|wxDirection::Top|wxDirection::Bottom, 5);

    wxBoxSizer* itemBoxSizer18 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer4->Add(itemBoxSizer18, 0, wxStretch::Grow, 5);
    ...
    itemBoxSizer18->Add(itemStaticText19, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);

    wxBoxSizer* itemBoxSizer20 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer18->Add(itemBoxSizer20, 0, wxAlignment::Left|wxDirection::All, 5);

    itemBoxSizer20->Add(5, 5, 0, wxAlignment::CenterVertical, 5);

    wxFlexGridSizer* itemFlexGridSizer22 = new wxFlexGridSizer(0, 2, 0, 0);
    itemBoxSizer20->Add(itemFlexGridSizer22, 0, wxAlignment::CenterVertical, 5);
    ...
    itemFlexGridSizer22->Add(m_indentLeft, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer22->Add(itemStaticText25, 0, wxAlignment::Right|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer22->Add(m_indentLeftFirst, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer22->Add(m_indentRight, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer22->Add(itemStaticText29, 0, wxAlignment::Right|wxAlignment::CenterVertical|wxDirection::All, 5);

    std::vector<std::string> m_outlineLevelCtrlStrings;
    m_outlineLevelCtrl = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTINDENTSSPACINGPAGE_OUTLINELEVEL, "", wxDefaultPosition, wxSize(85, -1), m_outlineLevelCtrlStrings, ComboStyles::ReadOnly );
    m_outlineLevelCtrl->SetHelpText(_("The outline level."));
    if (wxRichTextIndentsSpacingPage::ShowToolTips())
        m_outlineLevelCtrl->SetToolTip(_("The outline level."));
    itemFlexGridSizer22->Add(m_outlineLevelCtrl, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemBoxSizer4->Add(itemStaticLine32, 0, wxStretch::Grow|wxDirection::Top|wxDirection::Bottom, 5);

    itemBoxSizer4->Add(2, 1, 1, wxAlignment::CenterVertical|wxDirection::Top|wxDirection::Bottom, 5);

    wxBoxSizer* itemBoxSizer34 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer4->Add(itemBoxSizer34, 0, wxStretch::Grow, 5);
    ...
    itemBoxSizer34->Add(itemStaticText35, 0, wxAlignment::Left|wxDirection::Left|wxDirection::Right|wxDirection::Top, 5);

    wxBoxSizer* itemBoxSizer36 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer34->Add(itemBoxSizer36, 0, wxAlignment::Left|wxDirection::All, 5);

    itemBoxSizer36->Add(5, 5, 0, wxAlignment::CenterVertical, 5);

    wxFlexGridSizer* itemFlexGridSizer38 = new wxFlexGridSizer(30, 2, 0, 0);
    itemBoxSizer36->Add(itemFlexGridSizer38, 0, wxAlignment::CenterVertical, 5);
    ...
    itemFlexGridSizer38->Add(itemStaticText39, 0, wxAlignment::Right|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer38->Add(m_spacingBefore, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer38->Add(itemStaticText41, 0, wxAlignment::Right|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer38->Add(m_spacingAfter, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemFlexGridSizer38->Add(itemStaticText43, 0, wxAlignment::Right|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    m_spacingLine = new wxComboBox( itemRichTextDialogPage1, ID_RICHTEXTINDENTSSPACINGPAGE_SPACING_LINE, _("(none)"), wxDefaultPosition, wxSize(85, -1), m_spacingLineStrings, ComboStyles::ReadOnly );
    ...
    itemFlexGridSizer38->Add(m_spacingLine, 0, wxStretch::Grow|wxAlignment::CenterVertical|wxDirection::All, 5);
    ...
    itemBoxSizer34->Add(m_pageBreakCtrl, 0, wxAlignment::Left|wxDirection::All, 5);

    itemBoxSizer3->Add(5, 5, 0, wxAlignment::CenterHorizontal, 5);

    m_previewCtrl = new wxRichTextCtrl( itemRichTextDialogPage1, ID_RICHTEXTINDENTSSPACINGPAGE_PREVIEW_CTRL, "", wxDefaultPosition, wxSize(350, 100), wxBorder::Theme|wxVSCROLL|wxTE_READONLY );
    ...
    itemBoxSizer3->Add(m_previewCtrl, 1, wxAlignment::CenterHorizontal|wxDirection::All, 5);
