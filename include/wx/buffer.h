...
public:
    ...
    CharType *release() const
    {
        ...
        wxASSERT_MSG( m_data->m_owned, "can't release non-owned buffer" );
        wxASSERT_MSG( m_data->m_ref == 1, "can't release shared buffer" );
...
{
public:
	wxMemoryBufferData& operator=(wxMemoryBufferData&&) = delete;
...
public:
    ...
    {
        wxCHECK_RET( m_bufdata->m_data, "invalid wxMemoryBuffer" );
