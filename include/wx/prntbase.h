...
public:
    ...
    void SetPPIScreen(const wxSize& ppi) { SetPPIScreen(ppi.GetWidth(), ppi.GetHeight()); }
    ...
    void SetPPIPrinter(const wxSize& ppi) { SetPPIPrinter(ppi.GetWidth(), ppi.GetHeight()); }
