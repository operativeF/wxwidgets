...
public:
    ...
    wxString GetType() const override { return wxS("currency"); }
...
public:
    ...
    wxString GetType() const override { return wxS("errorcode"); }
...
public:
    ...
    wxString GetType() const override { return wxS("safearray"); }
