...
inline constexpr unsigned int wxQUANTIZE_INCLUDE_WINDOWS_COLOURS = 0x01;
inline constexpr unsigned int wxQUANTIZE_RETURN_8BIT_DATA        = 0x02;
inline constexpr unsigned int wxQUANTIZE_FILL_DESTINATION_IMAGE  = 0x04;
...
//// Operations
    ...
    static bool Quantize(const wxImage& src, wxImage& dest, wxPalette** pPalette, int desiredNoColours = 236,
        unsigned char** eightBitData = nullptr, unsigned int flags = wxQUANTIZE_INCLUDE_WINDOWS_COLOURS|wxQUANTIZE_FILL_DESTINATION_IMAGE|wxQUANTIZE_RETURN_8BIT_DATA);
