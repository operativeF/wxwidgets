...
inline constexpr unsigned int wxHL_CONTEXTMENU        = 0x0001;
inline constexpr unsigned int wxHL_ALIGN_LEFT         = 0x0002;
inline constexpr unsigned int wxHL_ALIGN_RIGHT        = 0x0004;
