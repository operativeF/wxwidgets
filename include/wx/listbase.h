...
wxDECLARE_EVENT( wxEVT_LIST_BEGIN_DRAG, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_BEGIN_RDRAG, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_BEGIN_LABEL_EDIT, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_END_LABEL_EDIT, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_DELETE_ITEM, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_DELETE_ALL_ITEMS, wxListEvent );

wxDECLARE_EVENT( wxEVT_LIST_ITEM_SELECTED, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_DESELECTED, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_KEY_DOWN, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_INSERT_ITEM, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_COL_CLICK, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_RIGHT_CLICK, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_MIDDLE_CLICK, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_ACTIVATED, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_CACHE_HINT, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_COL_RIGHT_CLICK, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_COL_BEGIN_DRAG, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_COL_DRAGGING, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_COL_END_DRAG, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_FOCUSED, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_CHECKED, wxListEvent );
wxDECLARE_EVENT( wxEVT_LIST_ITEM_UNCHECKED, wxListEvent );
