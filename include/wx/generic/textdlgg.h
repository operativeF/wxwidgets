...
inline constexpr WXDLLIMPEXP_DATA_CORE(char) wxGetTextFromUserPromptStr[] = "Input Text";
inline constexpr WXDLLIMPEXP_DATA_CORE(char) wxGetPasswordFromUserPromptStr[] = "Enter Password";
