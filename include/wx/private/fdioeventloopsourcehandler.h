...
public:
    ...
    void OnReadWaiting() override { m_handler->OnReadWaiting(); }
    void OnWriteWaiting() override { m_handler->OnWriteWaiting(); }
    void OnExceptionWaiting() override { m_handler->OnExceptionWaiting(); }
