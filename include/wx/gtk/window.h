...
public:
    ...
    void SetLabel(const wxString& label) override { m_gtkLabel = label; }
    wxString GetLabel() const override            { return m_gtkLabel; }

    // implementation
    // --------------

    WXWidget GetHandle() const override { return m_widget; }
