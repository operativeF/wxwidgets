...
// Placement flags
inline constexpr unsigned int wxWIZARD_VALIGN_TOP       = 0x01;
inline constexpr unsigned int wxWIZARD_VALIGN_CENTRE    = 0x02;
inline constexpr unsigned int wxWIZARD_VALIGN_BOTTOM    = 0x04;
inline constexpr unsigned int wxWIZARD_HALIGN_LEFT      = 0x08;
inline constexpr unsigned int wxWIZARD_HALIGN_CENTRE    = 0x10;
inline constexpr unsigned int wxWIZARD_HALIGN_RIGHT     = 0x20;
inline constexpr unsigned int wxWIZARD_TILE             = 0x40;
...
wxDECLARE_EVENT( wxEVT_WIZARD_PAGE_CHANGED, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_PAGE_CHANGING, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_CANCEL, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_HELP, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_FINISHED, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_PAGE_SHOWN, wxWizardEvent );
wxDECLARE_EVENT( wxEVT_WIZARD_BEFORE_PAGE_CHANGED, wxWizardEvent );
