...
constexpr wxChar wxACTION_BUTTON_TOGGLE[]  = wxT("toggle");    // press/release the button
constexpr wxChar wxACTION_BUTTON_PRESS[]   = wxT("press");     // press the button
constexpr wxChar wxACTION_BUTTON_RELEASE[] = wxT("release");   // release the button
constexpr wxChar wxACTION_BUTTON_CLICK[]   = wxT("click");     // generate button click event
