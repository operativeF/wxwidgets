...
constexpr char SYMBOL_WXRICHTEXTLISTSTYLEPAGE_TITLE[] = "";
#define SYMBOL_WXRICHTEXTLISTSTYLEPAGE_IDNAME ID_RICHTEXTLISTSTYLEPAGE
constexpr wxSize SYMBOL_WXRICHTEXTLISTSTYLEPAGE_SIZE = {400, 300};
constexpr wxPoint SYMBOL_WXRICHTEXTLISTSTYLEPAGE_POSITION = wxDefaultPosition;
