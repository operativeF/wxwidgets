...
// Accessors and operations unique to this handler
    ...
    void SetTemporaryImageLocations(const std::vector<wxString>& locations) { m_imageLocations = locations; }
    const std::vector<wxString>& GetTemporaryImageLocations() const { return m_imageLocations; }
    ...
    static bool DeleteTemporaryImages(int flags, const std::vector<wxString>& imageLocations);
...
// Data members
    ...
    std::vector<wxString>   m_imageLocations;
