...
inline constexpr unsigned int SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_STYLE = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCLOSE_BOX;
inline constexpr unsigned int SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_IDNAME = ID_RICHTEXTSTYLEORGANISERDIALOG;
inline constexpr wxSize SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_SIZE = {400, 300};
inline constexpr wxPoint SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_POSITION = wxDefaultPosition;

/*!
 * Flags for specifying permitted operations
 */

inline constexpr unsigned int wxRICHTEXT_ORGANISER_DELETE_STYLES  = 0x0001;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_CREATE_STYLES  = 0x0002;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_APPLY_STYLES   = 0x0004;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_EDIT_STYLES    = 0x0008;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_RENAME_STYLES  = 0x0010;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_OK_CANCEL      = 0x0020;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_RENUMBER       = 0x0040;

// The permitted style types to show
inline constexpr unsigned int wxRICHTEXT_ORGANISER_SHOW_CHARACTER = 0x0100;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_SHOW_PARAGRAPH = 0x0200;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_SHOW_LIST      = 0x0400;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_SHOW_BOX       = 0x0800;
inline constexpr unsigned int wxRICHTEXT_ORGANISER_SHOW_ALL       = 0x1000;

// Common combinations
inline constexpr unsigned int wxRICHTEXT_ORGANISER_ORGANISE = (wxRICHTEXT_ORGANISER_SHOW_ALL|wxRICHTEXT_ORGANISER_DELETE_STYLES|wxRICHTEXT_ORGANISER_CREATE_STYLES|wxRICHTEXT_ORGANISER_APPLY_STYLES|wxRICHTEXT_ORGANISER_EDIT_STYLES|wxRICHTEXT_ORGANISER_RENAME_STYLES);
inline constexpr unsigned int wxRICHTEXT_ORGANISER_BROWSE = (wxRICHTEXT_ORGANISER_SHOW_ALL|wxRICHTEXT_ORGANISER_OK_CANCEL);
inline constexpr unsigned int wxRICHTEXT_ORGANISER_BROWSE_NUMBERING = (wxRICHTEXT_ORGANISER_SHOW_LIST|wxRICHTEXT_ORGANISER_OK_CANCEL|wxRICHTEXT_ORGANISER_RENUMBER);
