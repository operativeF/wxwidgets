...
void GUIFrame::AddMenuBar()
{
    ...
    m_menuSeeScr = new wxMenuItem( fileMenu, wxID_ZOOM_IN, wxString( _("&Open screenshots folder...") ) + wxT('\t') + "Ctrl+O"), _("Opens the directory where the screenshots are saved.", wxITEM_NORMAL );
    fileMenu->Append( m_menuSeeScr );

    fileMenu->AppendSeparator();

    wxMenuItem* m_menuFileQuit;
    m_menuFileQuit = new wxMenuItem( fileMenu, wxID_EXIT, wxString( _("&Quit") ) + wxT('\t') + "Alt+F4"), _("Quits the application.", wxITEM_NORMAL );
    ...
    m_menuCapFullScreen = new wxMenuItem( captureMenu, idMenuCapFullScreen, wxString( _("&Full Screen") ) + wxT('\t') + "Ctrl+Alt+F"), _("Takes a screenshot of the entire screen.", wxITEM_NORMAL );
    captureMenu->Append( m_menuCapFullScreen );

    wxMenuItem* m_menuCapAll;
    m_menuCapAll = new wxMenuItem( captureMenu, idMenuCapAll, wxString( _("Capture All") ) + wxT('\t') + "Ctrl+Alt+A"), _("Takes screenshots for all controls automatically.", wxITEM_NORMAL );
    ...
    m_menuHelpAbout = new wxMenuItem( helpMenu, wxID_ABOUT, wxString( _("&About") ) + wxT('\t') + "F1"), _("Shows info about this application.", wxITEM_NORMAL );
...
void GUIFrame::AddPanel_1()
{
    ...
    */
    ...
    m_bpButton1 = new wxBitmapButton( m_panel1, wxID_ANY, wxBitmap( "bitmaps/wxwin32x32.png", wxBitmapType::Any ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_bitmap1 = new wxStaticBitmap( m_panel1, wxID_ANY, wxBitmap( "bitmaps/wxwin32x32.png", wxBitmapType::Any ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_hyperlink1 = new wxHyperlinkCtrl( m_panel1, wxID_ANY, _("www.wxwidgets.org"), "http://www.wxwidgets.org", wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
    ...
    m_spinCtrl1 = new wxSpinCtrl( m_panel1, wxID_ANY, "5", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
...
void GUIFrame::AddPanel_2()
{
    ...
    wxStaticText* m_collSText = new wxStaticText(win, -1, "You can place");
    wxButton* m_collBut = new wxButton(win, -1, "anything");
    wxTextCtrl* m_collText = new wxTextCtrl(win, -1, "inside a wxCollapsiblePane");
    ...
    //wxCollapsiblePane 2
    m_collPane2 = new wxCollapsiblePane(m_panel2, -1, "Expanded");
    ...
    wxStaticText* m_collSText2 = new wxStaticText(win2, -1, "You can place");
    wxButton* m_collBut2 = new wxButton(win2, -1, "anything");
    wxTextCtrl* m_collText2 = new wxTextCtrl(win2, -1, "inside a wxCollapsiblePane");
...
void GUIFrame::AddPanel_4()
{
    ...
    m_genericDirCtrl1 = new wxGenericDirCtrl( m_panel4, wxID_ANY, {}, wxDefaultPosition, wxDefaultSize, wxDIRCTRL_3D_INTERNAL|wxSUNKEN_BORDER, {}, 0, "_GenericDirCtrl" );
...
void GUIFrame::AddPanel_5()
{
    ...
    */
    ...
    m_bmpComboBox1->Append(_("Item1"), wxBitmap("bitmaps/bell.png",wxBitmapType::PNG));
    m_bmpComboBox1->Append(_("Item2"), wxBitmap("bitmaps/sound.png",wxBitmapType::PNG));
    m_bmpComboBox1->Append(_("Item3"), wxBitmap("bitmaps/bell.png",wxBitmapType::PNG));
    m_bmpComboBox1->Append(_("Item4"), wxBitmap("bitmaps/sound.png",wxBitmapType::PNG));
    ...
    //wxComboCtrl 1
        ...
        m_comboCtrl1->SetText("wxComboCtrl");
        m_comboCtrl1->SetToolTip(_("wxComboCtrl"));

        // Populate using wxListView methods
        popupList->InsertItem(popupList->GetItemCount(),"wxComboCtrl");
        popupList->InsertItem(popupList->GetItemCount(),"with");
        popupList->InsertItem(popupList->GetItemCount(),"wxListView");
        popupList->InsertItem(popupList->GetItemCount(),"popup");
        popupList->InsertItem(popupList->GetItemCount(),"Item1");
        popupList->InsertItem(popupList->GetItemCount(),"Item2");
        popupList->InsertItem(popupList->GetItemCount(),"Item3");
    ...
    //wxComboCtrl 2
        ...
        m_comboCtrl2->SetText("wxComboCtrl");
